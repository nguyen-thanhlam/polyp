#New script for polyp data
pacman::p_load(haven, gtsummary, pROC, rsample, ggplot2, rms, predtools, readxl, dcurves)

df <- read_xlsx("C:\\R\\Polyp\\data\\polyp.xlsx")
{
# As factor for Sex variable
...
df$Tuoicao <- factor(df$Tuoicao, levels = c(0,1), labels = c("<50yrs", ">=50rs"))
