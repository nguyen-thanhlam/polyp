...
pacman::p_load(haven, gtsummary, pROC, rsample, ggplot2, rms, predtools, readxl, dcurves, survival)
...
summary(mod3)
concordance(mod3)
coords(roc3, x = "best", input = "threshold", best.method="youden")
roc.test(roc4,roc5)
...
coords(roc3, x = "best", best.method="youden", ret = c("threshold", "accuracy", "sensitivity", "specificity", "npv", "ppv"))
